...
public class DummyXAResource implements XAResource {
    ...
    public void commit(Xid xid, boolean onePhase) throws XAException {
        if (kill) {
            System.out.println("Dummy: crashing the system");
    ...
    public Xid[] recover(int flag) throws XAException {
        ...
        System.out.printf("Dummy: returning xids '%s' to recover\n", Arrays.toString(xids));
        return xids;
    }
    ...
    public void end(Xid xid, int flags) throws XAException {
        System.out.printf("Dummy: end xid '%s'\n", xid);
    }

    @Override
    public void forget(Xid xid) throws XAException {
        System.out.printf("Dummy: forget xid '%s'\n", xid);
        removeXid(xid);
    }
    ...
    private void persistXid(Xid xid) throws XAException {
        System.out.printf("Dummy: persisting xid '%s'\n", xid);
    ...
    private void removeXid(Xid xid) throws XAException {
        System.out.printf("Dummy: removing xid '%s'\n", xid);
        try {
